                    ...
                    <TabsList className="inline-flex w-max min-w-full">
                      {QR_TYPE_CATEGORIES.map((cat) => (
                        <TabsTrigger
                          ...
                          className="min-w-[140px] transition-all duration-200 ease-in-out hover:bg-muted hover:text-foreground hover:shadow-sm hover:-translate-y-0.5 data-[state=active]:bg-background data-[state=active]:text-primary data-[state=active]:translate-y-0 data-[state=active]:font-semibold disabled:pointer-events-none"
                        >
                          {cat.label}
                        </TabsTrigger>
                      ))}
