...
export function getAIConfig() {
  return {
    ...
    googleApiKey: getOptionalEnv('GOOGLE_GENERATIVE_AI_API_KEY'),
    gatewayApiKey: getOptionalEnv('AI_GATEWAY_API_KEY'),
    gatewayBaseUrl: getOptionalEnv('AI_GATEWAY_BASE_URL'),
